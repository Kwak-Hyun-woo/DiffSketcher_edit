...
class TokenImage2AttnMixinASDSPipeline(StableDiffusionPipeline):
    r"""
    Pipeline for text,image-to-image generation using Stable Diffusion.
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # compute the previous noisy sample x_t -> x_t-1 (backward process)
    ...
    def get_cross_attention(self,
        ...
        view_images(image_array, save_image=not args.dataset, fp=save_path)
    ...
    def get_self_attention_comp(self,
        ...
        view_images(image_array, num_rows=max_com // 10, offset_ratio=0,
                    save_image=not args.dataset, fp=save_path / "self-attn-vh.png")

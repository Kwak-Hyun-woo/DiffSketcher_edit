...
class Loss(nn.Module):
    def __init__(self, args):
        ...
        self.args = args
        self.percep_loss = args.percep_loss # default: None

        self.train_with_clip = args.train_with_clip # default: 0
        self.clip_weight = args.clip_weight         # default: 0
        self.start_clip = args.start_clip           # default: 0

        self.clip_conv_loss = args.clip_conv_loss       # default: 1
        self.clip_fc_loss_weight = args.clip_fc_loss_weight # default: 0.1
        self.clip_text_guide = args.clip_text_guide     # default: 0
    ...
    def get_losses_to_apply(self):
        losses_to_apply = []
        # if self.percep_loss != "none" or self.percep_loss != 'None':
